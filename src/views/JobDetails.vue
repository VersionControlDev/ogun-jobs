        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="post-details3  mb-50">
                    ...
                    <ul>
                        <li>Posted date : <span>12 Aug 2024</span></li>
                        <li>Location : <span>Ijebu Ode</span></li>
                        <li>Vacancy : <span>05</span></li>
                        <li>Job nature : <span>Full time</span></li>
                        <li>Salary : <span>$7,800 yearly</span></li>
                        <li>Application date : <span>12 Sep 2024</span></li>
                    </ul>
                ...
                <div class="post-details4  mb-50">
                    ...
                    <ul>
                        <li>Name: <span>EduTAMS </span></li>
                        <li>Web : <span> edutams.net</span></li>
                        <li>Email: <span>admin@admin.com</span></li>
                    </ul>
                </div>
            </div>
        </div>
